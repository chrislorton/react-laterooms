...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(9);
	var HotelList = __webpack_require__(168);
	var hotels = __webpack_require__(170);
	var FilterComponent = __webpack_require__(171);
	var SortComponent = __webpack_require__(172);
	...
	var Main = React.createClass({
	    ...
	    handleFilter: function handleFilter(filterCarPark) {
	        this.setState({
	            filterCarPark: filterCarPark
	        });
	    },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'col-xs-12' },
	                    React.createElement(HotelList, { hotels: hotels })
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(9);
	var Hotel = __webpack_require__(169);

	var HotelList = React.createClass({
	    displayName: 'HotelList',

	    render: function render() {
	        var hotels = this.props.hotels;


	        var renderHotels = function renderHotels() {
	            return hotels.map(function (hotel, i) {
	                return React.createElement(Hotel, _extends({ key: i }, hotel));
	            });
	        };
	        return React.createElement(
	            'div',
	...
	var Hotel = React.createClass({
	    ...
	    render: function render() {
	        var _props = this.props,
	            Name = _props.Name,
	            StarRating = _props.StarRating,
	            Facilities = _props.Facilities;
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement("input", { className: "form-check-input", type: "checkbox", ref: "filterCarPark", defaultChecked: "true", id: "filterComponent__option--car-park", value: "carpark", onChange: this.handleFilter }),
	                " Car Park"
	            )
	        );
	    }
...
/***/ function(module, exports) {
	...
	var toggleShowCarPark = exports.toggleShowCarPark = function toggleShowCarPark() {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(196),
	    carParkReducer = _require.carParkReducer;
...
/***/ function(module, exports) {
	...
	var carParkReducer = exports.carParkReducer = function carParkReducer() {
